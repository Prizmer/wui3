        ...
        if (is_electric_monthly == "1"):
            ...
            for x in range(len(list_of_abonents_2)):
                ...
                if data_table_temp:
                    ...
                    data_table.extend([['', list_of_abonents_2[x],'Н/Д','Н/Д','Н/Д','Н/Д','Н/Д','Н/Д','Н/Д']])
# Заполняем отчет значениями
    for row in range(6, len(data_table)+6):
        try:
...
# Конец наполнения отчёта
    ...
    output_name = 'rashod_3_zones ' + str(electric_data_start) + ' - ' + str(electric_data_end)
    file_ext = 'xlsx'
    ...
    if (bool(is_abonent_level.search(obj_key))):        
        ...
        for x in range(len(list_of_abonents_2)):
            ...
            if list_of_abonents_2[x][0] in list_except:
                ...
                data_table.extend([[0,list_of_abonents_2[x][0],'Н/Д','Н/Д','Н/Д','Н/Д']])
...
#------------
    ...
    output_name = 'potreblenie_heat_report'
    file_ext = 'xlsx'
