...
-- Напряжение батарейки (возьмем для примера ресурс электричество)
INSERT INTO public.names_params(
	guid, name, guid_measurement, guid_resources)
	VALUES ('06f68849-3e99-4f36-9650-a2687a82f468','battery_voltage', '06f68849-3e99-4f36-9650-a2687a82f465', 'ba710cff-e390-48ca-b442-70141c9864f7');
-----------------------------------------------------------------
