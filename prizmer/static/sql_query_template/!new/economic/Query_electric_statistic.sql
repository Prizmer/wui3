select obj_name, count (t0) as have_val,  count (ab_name) as all_row, round((count(t0)*100/count(ab_name))::numeric,2) as percent_val, (count (ab_name)-count (t0)) as no_val
from
(
