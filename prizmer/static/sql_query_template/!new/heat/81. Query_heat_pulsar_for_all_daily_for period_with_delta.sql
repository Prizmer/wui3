...
(select c_date::date
from
generate_series('31.05.2018'::timestamp without time zone, '06.06.2018'::timestamp without time zone, interval '1 day') as c_date) z_date
left join
(SELECT z1.daily_date, z1.name_objects,  
            ...
            sum(Case when z1.params_name = 'To' then z1.value_daily  end) as t_out
            			...
            			WHERE 
            			  ...
            			  daily_values.date between '31.05.2018' and '06.06.2018'
                                    ) z1                      
