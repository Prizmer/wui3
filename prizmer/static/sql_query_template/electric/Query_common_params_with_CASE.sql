...
z1.ktn, z1.ktt, z1.a 
                 ...
                 abonents.name = 'ВРУ-1 АВР' AND objects.name = 'Корпус Б' AND                      
                        daily_values.date = '09.08.2016' 
                        ) z1                      
...
where electric_abons.ab_name = 'ВРУ-1 АВР' AND electric_abons.obj_name='Корпус Б'
