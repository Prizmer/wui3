...
ROUND_SIZE = 0 #Сколько знаков после запятой будет выводится в отчёт excel
...
SHOW_HEAT_IN_WATER = False #показывать ли в дереве объетов Воды имульсные каналы теплосчётчиков
NUM_IS_STRING = False #выводить ли в отчёты числа как строку или как число
