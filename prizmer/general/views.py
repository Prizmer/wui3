        ...
        for l0 in range(len(all_level_0)):
            ...
            for l1 in range(len(filter_level_1)):                            
                ...
                if len(list_of_level_2) > 0:
                    ...
                    list_of_level_1 = {"key":"level1-"+str(l1), "title": filter_level_1[l1].name }
                    children_data_l1.append(list_of_level_1)
...
#*********************************************************************************************************************************************************************
    ...
    args['is_electric_period'] = is_electric_period
    args['dates'] = dates
    return render(request, "data_table/electric/15.html", args)
...
#                data_table = []
                for x in range(len(abonents_list)):
                    ...
                    if not data_table_temp:
                        data_table_temp = [[electric_data_end, abonents_list[x][0], 'Н/Д', 'Н/Д', 'Н/Д', 'Н/Д']]
                    data_table.extend(data_table_temp)
#*********************************************************************************************************************************************************************
...
#                data_table = []
                for x in range(len(abonents_list)):
                    ...
                    if not data_table_temp:
                        data_table_temp = [[electric_data_end, abonents_list[x][0], 'Н/Д', 'Н/Д', 'Н/Д', 'Н/Д', 'Н/Д']]        
                    data_table.extend(data_table_temp)
#*********************************************************************************************************************************************************************
            elif (is_electric_daily == '1'): # daily for abonents group
...
def pokazaniya_heat(request):
    ...
    list_except = ['ВРУ Счётчик01','ВРУ Счётчик02','ВРУ Счётчик03','ВРУ Счётчик04','ВРУ Счётчик05','ВРУ Счётчик06','ВРУ Счётчик07','ВРУ Счётчик08','ВРУ Счётчик09','ВРУ Счётчик10','ВРУ Счётчик11','ВРУ Счётчик12','ВРУ Счётчик13','ВРУ Счётчик14','ВРУ Счётчик15','ВРУ Счётчик16','ВРУ Счётчик17','ВРУ Счётчик18','ВРУ Счётчик19','ВРУ Счётчик20','ВРУ Счётчик21','ВРУ Счётчик22','ВРУ Счётчик23','Гараж Счётчик 1','Гараж Счётчик 2']
    ...
    if (bool(is_abonent_level.search(obj_key))):     
        ...
        for x in range(len(list_of_abonents_2)):
            ...
            if list_of_abonents_2[x][0] in list_except:
                ...
                data_table.extend([[0,list_of_abonents_2[x][0],'Н/Д','Н/Д','Н/Д']])
    ...
    if (bool(is_abonent_level.search(obj_key))):        
        ...
        for x in range(len(list_of_abonents_2)):
            ...
            if list_of_abonents_2[x][0] in list_except:
                ...
                data_table.extend([[0,list_of_abonents_2[x][0],'Н/Д','Н/Д','Н/Д','Н/Д','Н/Д']])
    ...
    if (bool(is_abonent_level.search(obj_key))):        
        ...
        for x in range(len(list_of_abonents_2)):
            ...
            if list_of_abonents_2[x][0] in list_except:
                ...
                data_table.extend([['Н/Д','Н/Д',list_of_abonents_2[x][0],'Н/Д','Н/Д','Н/Д','Н/Д','Н/Д','Н/Д','Н/Д','Н/Д']])
...
def forma_80020(request):
    ...
    return render(request, "data_table/electric/41.html", args)
