...
def pulsar_water_battery(request):
    ...
    return render(request, "data_table/water/140.html", args)
...
def electric_3_zones_v2(request):
    args = {}
    is_abonent_level = re.compile(r'abonent')
    is_object_level = re.compile(r'level')
    is_group_level = re.compile(r'group')
    ...
    if request.is_ajax():
        if request.method == 'GET':
            ...
            #print('!!!!!!!',obj_key, bool(is_group_level.search(obj_key)), bool(is_abonent_level.search(obj_key)), bool(is_object_level.search(obj_key)) )
...
#*********************************************************************************************************************************************************************
    ...
    return render(request,"data_table/electric/114.html", args)
...
#*********************************************************************************************************************************************************************
    ...
    return render(request, "data_table/heat/116.html", args)

def stk_heat_period(request):
    args = {}
    is_abonent_level = re.compile(r'abonent')
    is_object_level_2 = re.compile(r'level2')
...
#*********************************************************************************************************************************************************************
    ...
    return render(request, "data_table/heat/115.html", args)

def pulsar_frost_daily(request):
    args = {}
    is_abonent_level = re.compile(r'abonent')
    is_object_level_2 = re.compile(r'level2')
    is_group_level = re.compile(r'group')
...
#*********************************************************************************************************************************************************************
    ...
    return render(request, "data_table/heat/118.html", args)

def pulsar_frost_period(request):
    args = {}
    is_abonent_level = re.compile(r'abonent')
    is_object_level_2 = re.compile(r'level2')
...
#*********************************************************************************************************************************************************************
    ...
    return render(request, "data_table/heat/117.html", args)

def all_res_by_day_for_year(request):
    args = {}
    is_abonent_level = re.compile(r'abonent')
    is_object_level_2 = re.compile(r'level2')
...
#*********************************************************************************************************************************************************************
            if (bool(is_abonent_level.search(obj_key))): #выбран абонент
                ...
                #data_table_electric = common_sql.get_data_table_electric_for_year_by_day(obj_parent_title, obj_title, electric_data_end)
...
def pulsar_water_from_heat_daily_row(request):
    args = {}
    is_abonent_level = re.compile(r'abonent')
    is_object_level_2 = re.compile(r'level2')
    data_table = []
    ...
    args['electric_data_start'] = electric_data_start
    args['electric_data_end'] = electric_data_end
    return render(request, "data_table/water/136.html", args)

def danfoss_water_impulse_daily(request):
    args = {}
    is_abonent_level = re.compile(r'abonent')
    is_object_level_2 = re.compile(r'level2')
    data_table = []
    ...
    args['electric_data_start'] = electric_data_start
    args['electric_data_end'] = electric_data_end
    return render(request, "data_table/water/134.html", args)

def danfoss_water_impulse_consumption(request):
    args = {}
    is_abonent_level = re.compile(r'abonent')
    is_object_level_2 = re.compile(r'level2')
    data_table = []
    ...
    # args['label'] = Xcoord
    # args['AllData']=AllData
    return render(request, "data_table/water/133.html", args)

def econom_water_daily(request):
    args = {}
    is_abonent_level = re.compile(r'abonent')
    is_object_level_2 = re.compile(r'level2')
    data_table = []
    ...
    return render(request, "data_table/water/142.html", args)

def econom_water_period(request):
    args = {}
    is_abonent_level = re.compile(r'abonent')
    is_object_level_2 = re.compile(r'level2')
    data_table = []
    ...
    sortDir = 'ASC'              
    if (bool(is_abonent_level.search(obj_key))):
        data_table = common_sql.get_data_table_econom_water_for_period(obj_parent_title, obj_title, electric_data_start, electric_data_end, True, sortDir)
    elif (bool(is_object_level_2.search(obj_key))):
        data_table = common_sql.get_data_table_econom_water_for_period(obj_parent_title, obj_title, electric_data_start,electric_data_end, False, sortDir)
    ...
    return render(request, "data_table/water/141.html", args)
...
def pulsar_water_consumption_mosvodokanal_from_template(request):
    ...
    return render(request, "data_table/146.html", args)
...
def analize_water_consumption(request):
    args = {}
    is_abonent_level = re.compile(r'abonent')
    is_object_level_2 = re.compile(r'level2')
    data_table = []
...
def pulsar_frost_daily_floors(request):
    SHOW_STOYAK = getattr(settings, 'SHOW_STOYAK', 'False')
    SHOW_FLOORS = getattr(settings, 'SHOW_FLOORS', 'True')
    args = {}
    is_abonent_level = re.compile(r'abonent')
...
#*********************************************************************************************************************************************************************
    ...
    return render(request, "data_table/heat/154.html", args)


def impulse_heat_by_date(request):
    args= {}
    is_abonent_level = re.compile(r'level2')
    is_object_level_2 = re.compile(r'level1')    
    parent_name         = request.GET['obj_parent_title']
    ...
    return render(request, "data_table/water/156.html", args)

    
def impulse_heat_consumption(request):
    args= {}
    is_abonent_level = re.compile(r'level2')
    is_object_level_2 = re.compile(r'level1')
    ...
    if (bool(is_abonent_level.search(obj_key))): 
        data_table = common_sql.get_data_table_heat_impulse_consumption(meters_name, parent_name,electric_data_start, electric_data_end, True)
    elif (bool(is_object_level_2.search(obj_key))):
        data_table = common_sql.get_data_table_heat_impulse_consumption(meters_name, parent_name,electric_data_start, electric_data_end, False)
...
def heat_vkt9_daily(request):
    ...
    return render(request, "data_table/heat/162.html", args)


def heat_ridan_daily(request):
    args= {}
    is_abonent_level = re.compile(r'abonent')
    is_object_level_2 = re.compile(r'level2')   
    parent_name         = request.GET['obj_parent_title']
    ...
    return render(request, "data_table/heat/164.html", args)

def heat_ridan_consumption(request):
    args= {}
    is_abonent_level = re.compile(r'abonent')
    is_object_level_2 = re.compile(r'level2')   
    parent_name         = request.GET['obj_parent_title']
    ...
    return render(request, "data_table/heat/165.html", args)

def water_ridan_daily(request):
    args= {}
    is_abonent_level = re.compile(r'abonent')
    is_object_level_2 = re.compile(r'level2')   
    parent_name         = request.GET['obj_parent_title']
    ...
    return render(request, "data_table/water/166.html", args)

def water_ridan_consumption(request):
    args= {}
    is_abonent_level = re.compile(r'abonent')
    is_object_level_2 = re.compile(r'level2')   
    parent_name         = request.GET['obj_parent_title']
