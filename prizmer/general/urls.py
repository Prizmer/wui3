...
urlpatterns = [
   ...
   #---- Test urls
    ...
    url(r'^146/$', views.pulsar_water_consumption_mosvodokanal_from_template, name = 'pulsar_water_consumption_mosvodokanal_from_template'), # Отчёт по отреблению для мосводокаанала на Дискавери с загрузкой из шаблона
    ...
    url(r'^164/$', views.heat_ridan_daily, name = 'heat_ridan_daily'), # тепло с приборов ридан
    url(r'^165/$', views.heat_ridan_consumption, name = 'heat_ridan_consumption'), # тепло с приборов ридан
    ...
    url(r'^175/$', views.heat_monthly_VIST, name = 'heat_monthly_VIST'), # отчёт месячный протокол учёта тепловой энергии за месяц
]
